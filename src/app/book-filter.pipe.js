...
var BookFilterPipe = (function () {
    ...
    BookFilterPipe.prototype.transform = function (value, filterBy) {
        filterBy = filterBy ? filterBy.toLocaleLowerCase() : null;
        return filterBy ? value.filter(function (book) {
            return book.bookTitle.toLocaleLowerCase().indexOf(filterBy) !== -1;
        }) : value;
    };
